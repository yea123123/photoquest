...
enum QuestKeywords {
    ...
    static let all: [String: [String]] = [
        ...
        "птица": ["robin", "magpie", "jay", "sparrow", "finch", "chickadee", "hummingbird", "cock",
                  ...
                  "peacock", "owl", "eagle", "hawk", "parrot", "macaw", "bird"],
        ...
        "дикое животное": ["lion", "tiger", "leopard", "zebra", "elephant", "giraffe", "monkey",
                           ...
                           "chinchilla", "gerbil"],
        "рыба": ["goldfish", "trout", "shark", "eel", "stingray", "barracouta", "coho", "tench", "puffer"],
        ...
        // Техника
        "телефон": ["cellular telephone", "ipod"],
        "компьютер": ["laptop", "desktop computer", "notebook", "monitor", "computer keyboard",
                      "computer mouse", "printer", "modem", "hard disc"],
